...
function displaysubcatListview(){
    ...
    for(var j=0;j<Content_json.result.length;j++){
        html+= '<li class="collection-item"><div id="'+Content_json.result[j].id+'" onclick="renderHomepage()" style=" font-size: 16px" q>'+Content_json.result[j].title+'<span style=" float: right"><i class="material-icons">chevron_right</i></span></div></li>'
    }
    html+= '</ul>'
//this.id
    window.setTimeout(function(){
